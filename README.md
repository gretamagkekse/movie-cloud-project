...
```
cd existing_repo
git remote add origin https://git.tu-berlin.de/modern-cloud-project-sose2024/project-team-yellow.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.tu-berlin.de/modern-cloud-project-sose2024/project-team-yellow/-/settings/integrations)
